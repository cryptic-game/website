  ...
  <main class="index-page">
    ...
    <section class="section second-section">
      <div class="second-section__content content flex-with-gutter">
        <span>You can already play an early version:</span>
    ...
    <section class="section desc-section">
      <div class="desc-section__content content">
        <div class="desc-section__part">
          <h2 class="desc-section__title">The Project</h2>
          <p>
            ...
            >The Morpheus</a>. It
            was first announced on October 15, 2017 with an
            <a
              class="link"
              href="https://www.youtube.com/watch?v=iOJhuw7eABk"
            >announcement video (german)</a>. The goal of the project is to create a unique experience for the
            players, but primarily make it possible for people interested in
            coding and computer science to develop and improve their existing
            skills and create something great. This includes the determining of
            the game content, the design, sounds, the programming, the testing
            and the server maintenance.
          </p>
          <p>
            Together, we daily strive to make Cryptic better and want to give
            you an interesting, adventurous and playful introduction into the
            world of hacking.
          </p>
        </div>
        <div class="desc-section__part">
          <h2 class="desc-section__title">What is Cryptic?</h2>
          <p>
            Cryptic is a MMO Hacking-Simulation with realtime strategy elements.
            Using specific programs and command, you can infiltrate the systems
            of other players and the global infrastructure. Level up your
            hardware and software, produce your own malware in your development
            center or communicate with other players to plan a joint attack. But
            this is just the beginning.
          </p>
          <p>
            Help the cyber police as a white hat to put a stop to the activities
            of malicious hackers or become a black hat, cripple whole networks
            and spy the other players.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="section faq-section">
      <div class="content">
        ...
        <div>
          <h3 class="faq-section__question">How can I contribute?</h3>Read our
          <nuxt-link class="link" to="/contributing">Contributing Guide</nuxt-link>.
        </div>
        <div>
          <h3 class="faq-section__question">How is the project financed?</h3>Nobody gets paid for working on the project, but we have to pay for
          our servers. So if you want to sponsor us,
          <a
            class="link"
            href="https://www.patreon.com/user?u=5322110"
          >support The Morpheus on Patreon</a>.
        </div>
      </div>
    </section>
    <section class="section team-section">
      ...
      <div class="text">
        <p>Du willst wissen, was hinter Cryptik steht?</p>
        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p>
        <p>Wende dich an uns, wenn du noch Fragen hast!</p>
      </div>
    </section>
    <KFooter />
  </main>
